...
const htmlFiles = readdirSync('docs')
  .filter(f => f.startsWith('did-') && f.endsWith('.html'))
  .sort()
  .reverse();
...
for (const name of htmlFiles.slice(0, 30)) {
  const date = name.replace('did-', '').replace('.html', '');
...
<title>DID Brain · 解離性身份障礙文獻日報</title>
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .link-row a { display: inline-flex; align-items: center; gap: 6px; padding: 10px 18px; font-size: 13px; }
...
<div class="container">
  <div class="logo">🧠</div>
  <h1>DID Brain</h1>
  <p class="subtitle">解離性身份障礙文獻日報 · 每日自動更新</p>
  ...
  <footer>
    <p>Powered by PubMed + NVIDIA AI · <a href="https://github.com/u8901006/did-brain">GitHub</a></p>
  </footer>
</div>
</body>
</html>`;
